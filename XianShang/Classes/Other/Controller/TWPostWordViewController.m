...
- (void)composeToolbar:(IWComposeToolbar *)toolbar didClickedButton:(IWComposeToolbarButtonType)buttonType
{
    switch (buttonType) {
        ...
        case IWComposeToolbarButtonTypePicture: // 相册
            ...
            break;
        case IWComposeToolbarButtonTypeTrend: // 位置
            [self openLocatelist];
            break;
...
- (void)openLocatelist{
    TWLocateViewController *lvc = [[TWLocateViewController alloc] init];
    TWNavigationController *nav = [[TWNavigationController alloc]initWithRootViewController:lvc];
...
- (void)openCamera
{
    TWContractTableViewController *lvc = [[TWContractTableViewController alloc] init];
    TWNavigationController *nav = [[TWNavigationController alloc]initWithRootViewController:lvc];
    [self presentViewController:nav animated:YES completion:nil];
}
